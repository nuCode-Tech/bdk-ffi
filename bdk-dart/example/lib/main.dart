...
class _WalletHomePageState extends State<WalletHomePage> {
  ...
  Network _network = Network.regtest; // Changed to regtest - most common for local electrs
  ...
  Future<void> _initializeWallet() async {
    ...
    try {
      ...
      print('Wallet initialized with address: ${addressInfo.address} (index: ${addressInfo.index})');
  ...
  Future<void> _generateNewAddress() async {
    ...
    try {
      ...
      print('Generated address: ${addressInfo.address} (index: ${addressInfo.index})');
  ...
  Future<void> _refreshBalance() async {
    ...
    try {
      ...
      print('Balance: ${balance.total.toSat()} sats (Confirmed: ${balance.confirmed.toSat()}, Pending: ${balance.trustedPending.toSat()})');
      ...
      if (e.toString().contains('Connection refused') || e.toString().contains('connect')) {
        ...
        errorMessage = 'Connection timeout. Is electrs running at $_electrumUrl?';
      }
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () => _copyToClipboard(_addresses[index].address.toString()),
              ),
            ),
          ),
        ),
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.network_check, color: Colors.orange.shade700),
                      ...
                      const Text('Current Receive Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),
                      Card(
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton.icon(
                                    onPressed: () => _copyToClipboard(_currentAddress ?? ''),
                      ...
                      OutlinedButton.icon(
                        ...
                        label: Text('View All Addresses (${_addresses.length})'),
                      ),
                      const SizedBox(height: 24),
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              Text('• This is a ${_network.toString().split('.').last} testnet wallet'),
                              const Text('• Uses BIP84 (native SegWit)'),
                              const Text('• All data is stored in memory only'),
                              const Text('• Tap the key icon to view your recovery phrase'),
                            ],
                          ),
                        ),
                      ),
